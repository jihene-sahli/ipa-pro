...
INSERT INTO `BIZ_REGION` (`ID`, `INTITULE`) VALUES
(1, 'Centre'),
(2, 'Est'),
(3, 'Ouest'),
(4, 'Sud'),
...
ALTER TABLE `BIZ_WILAYA` ADD `CODE_WILAYA` INT NOT NULL AFTER `ID`;
INSERT INTO `BIZ_WILAYA` (`ID`, `CODE_WILAYA`, `INTITULE`, `ID_REGION`) VALUES
(1, 1, 'Adrar', 4),
(2, 2, 'Chlef', 3),
(3, 3, 'Laghouat', 4),
(4, 4, 'Oum El Bouaghi', 2),
(5, 5, 'Batna', 2),
(6, 6, 'Béjaïa', 2),
(7, 7, 'Biskra', 4),
(8, 8, 'Béchar', 4),
...
ALTER TABLE `BIZ_COMMUNE` ADD `CODE_POSTAL` VARCHAR(10) NOT NULL AFTER `ID`;
INSERT INTO `BIZ_COMMUNE` (`ID`, `CODE_POSTAL`, `INTITULE`, `ID_WILAYA`) VALUES
(1, '01001', 'Adrar', 1),
(2, '01002', 'Tamest', 1),
(3, '01003', 'Charouine', 1),
(4, '01004', 'Reggane', 1),
